...
<head>
    ...
    <title>NapCat机器人 - <?php echo htmlspecialchars($siteName); ?></title>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="bots_napcat.php">😺 NapCat机器人</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <form method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 mb-3">
                                    <label class="form-label">HTTP地址</label>
                                    <input type="text" name="http_url" class="form-control" placeholder="http://127.0.0.1:3000" required>
                                </div>
                                <div class="col-md-3 mb-3">
                                ...
                                <tbody>
                                    <?php foreach ($bots as $bot): ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($bot['qq']); ?></td>
                                            <td><?php echo htmlspecialchars($bot['http_url']); ?></td>
                                            <td><?php echo $bot['token'] ? htmlspecialchars(substr($bot['token'], 0, 10)) . '...' : '-'; ?></td>
